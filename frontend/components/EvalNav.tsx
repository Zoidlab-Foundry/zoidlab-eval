...
const LINKS = [
  ...
  { href: "/evaluate", label: "New Eval" },
  { href: "/targets", label: "Targets" },
  { href: "/testsets", label: "Test Sets" },
    ...
    <header className="sticky top-0 z-30 border-b border-line bg-bg/85 backdrop-blur">
      <div className="mx-auto flex h-14 w-full max-w-[1320px] items-center gap-5 px-5">
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <span className="text-[14px] font-semibold tracking-tight">ZoidLab <span className="text-dim font-normal">Eval</span></span>
          <span className="hidden rounded-full border border-vi/40 bg-vi/10 px-2 py-0.5 text-[9px] font-medium text-vi sm:inline">Foundry 09</span>
